...
# "R"  n -  Remove first n elements of the buffer. These n elements are the ones that were added
# earliest among the current elements.
# "L"   - List the elements of buffer in order of their inserting time.
# "Q"  - Quit.  
     
#execute commands on circular buffer.
...
#Output:
# Whenever  L command appears in the input, print the elements of
# buffer in order of their inserting time. Element that was added first should appear first.
